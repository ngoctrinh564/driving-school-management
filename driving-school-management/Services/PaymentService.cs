...
namespace driving_school_management.Services
{
    public class PaymentService
    {
        ...
        // THANH TOÁN MOMO
        // ============================================================
        public PaymentGatewayDto? GetMomoInfo(int userId, int phieuId)
        {
            PaymentGatewayDto? result = null;

            using (var conn = new OracleConnection(_connectionString))
            using (var cmd = new OracleCommand("SP_PAYMENT_GET_MOMO_INFO", conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_userId", OracleDbType.Int32).Value = userId;
                cmd.Parameters.Add("p_phieuId", OracleDbType.Int32).Value = phieuId;
        ...
        public PaymentGatewayDto? GetMomoInfoByPhieuId(int phieuId)
        {
            PaymentGatewayDto? result = null;

            using (var conn = new OracleConnection(_connectionString))
            using (var cmd = new OracleCommand("SP_PAYMENT_GET_MOMO_INFO_BY_PHIEU", conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_phieuId", OracleDbType.Int32).Value = phieuId;
                cmd.Parameters.Add("p_cursor", OracleDbType.RefCursor).Direction = ParameterDirection.Output;
        ...
        public int MarkMomoSuccess(int phieuId)
        {
            using (var conn = new OracleConnection(_connectionString))
            using (var cmd = new OracleCommand("SP_PAYMENT_MOMO_SUCCESS", conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_phieuId", OracleDbType.Int32).Value = phieuId;
        ...
        public int MarkMomoFail(int phieuId)
        {
            using (var conn = new OracleConnection(_connectionString))
            using (var cmd = new OracleCommand("SP_PAYMENT_MOMO_FAIL", conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("p_phieuId", OracleDbType.Int32).Value = phieuId;
